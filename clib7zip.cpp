...
c7zip_EXPORT bool c7zItm_GetUInt64Property(c7z_ArchiveItem *self,
  ...
  return static_cast<C7ZipArchiveItem *>(self)->GetUInt64Property(
      (lib7zip::PropertyIndexEnum)propertyIndex, *val);
}

c7zip_EXPORT bool c7zItm_GetFileTimeProperty(c7z_ArchiveItem *self,
                                             int propertyIndex,
                                             unsigned __int64 *const val) {
  return static_cast<C7ZipArchiveItem *>(self)->GetFileTimeProperty(
      (lib7zip::PropertyIndexEnum)propertyIndex, *val);
}
...
c7zip_EXPORT bool c7zItm_GetStringProperty(c7z_ArchiveItem *self,
  ...
  wstring _val;
  if (!static_cast<C7ZipArchiveItem *>(self)->GetStringProperty(
          (lib7zip::PropertyIndexEnum)propertyIndex, _val)) {
    return false;
  }
...
c7zip_EXPORT bool c7zItm_GetBoolProperty(c7z_ArchiveItem *self,
  ...
  return static_cast<C7ZipArchiveItem *>(self)->GetBoolProperty(
      (lib7zip::PropertyIndexEnum)propertyIndex, *val);
}
...
c7zip_EXPORT int c7zInSt_Seek(c7z_InStream *self, __int64 offset,
  ...
  return static_cast<C7ZipInStream *>(self)->Seek(offset, seekOrigin,
                                                  newPosition);
}
...
c7zip_EXPORT int c7zOutSt_Seek(c7z_OutStream *self, __int64 offset,
                               unsigned int seekOrigin,
                               unsigned __int64 *newPosition) {
  return static_cast<C7ZipOutStream *>(self)->Seek(offset, seekOrigin,
                                                   newPosition);
}
...
c7zip_EXPORT bool c7zArc_ExtractByIndex(c7z_Archive *self, unsigned int index,
  ...
  return static_cast<C7ZipArchive *>(self)->Extract(
      index, static_cast<C7ZipOutStream *>(pOutStream));
}
...
c7zip_EXPORT bool c7zArc_ExtractByIndexPW(c7z_Archive *self, unsigned int index,
  ...
  return static_cast<C7ZipArchive *>(self)->Extract(
      index, static_cast<C7ZipOutStream *>(pOutStream), pwd);
}
...
c7zip_EXPORT bool c7zArc_ExtractByItem(c7z_Archive *self,
                                       ...
                                       c7z_OutStream *pOutStream) {
  return static_cast<C7ZipArchive *>(self)->Extract(
      static_cast<const C7ZipArchiveItem *>(pArchiveItem),
      static_cast<C7ZipOutStream *>(pOutStream));
}
...
c7zip_EXPORT bool c7zArc_GetUInt64Property(c7z_Archive *self, int propertyIndex,
                                           unsigned __int64 *const val) {
  return static_cast<C7ZipArchive *>(self)->GetUInt64Property(
      (lib7zip::PropertyIndexEnum)propertyIndex, *val);
}

c7zip_EXPORT bool c7zArc_GetBoolProperty(c7z_Archive *self, int propertyIndex,
                                         bool *const val) {
  return static_cast<C7ZipArchive *>(self)->GetBoolProperty(
      (lib7zip::PropertyIndexEnum)propertyIndex, *val);
}
...
c7zip_EXPORT bool c7zArc_GetStringProperty(c7z_Archive *self, int propertyIndex,
                                           wchar_t **val) {
  wstring _val;
  if (!static_cast<C7ZipArchive *>(self)->GetStringProperty(
          (lib7zip::PropertyIndexEnum)propertyIndex, _val)) {
    return false;
  }
...
c7zip_EXPORT bool c7zArc_GetFileTimeProperty(c7z_Archive *self,
                                             int propertyIndex,
                                             unsigned __int64 *const val) {
  return static_cast<C7ZipArchive *>(self)->GetFileTimeProperty(
      (lib7zip::PropertyIndexEnum)propertyIndex, *val);
}
...
c7zip_EXPORT bool c7zLib_OpenArchive(c7z_Library *self, c7z_InStream *pInStream,
  ...
  bool r = static_cast<C7ZipLibrary *>(self)->OpenArchive(
      static_cast<C7ZipInStream *>(pInStream), &archive);
...
c7zip_EXPORT ErrorCodeEnum c7zLib_GetLastError(c7z_Library *self) {
  return static_cast<ErrorCodeEnum>(
      static_cast<C7ZipLibrary *>(self)->GetLastError());
}
